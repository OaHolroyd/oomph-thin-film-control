...
typedef enum { UNCONTROLLED = 0, PAIR, LQR, STATIC, DYNAMIC } control_t;
...
void control_set(control_t ct, rom_t rt, int m, int p, double w, double alpha, double mu, double del, double lx, double ly, int nx, int ny, double re, double ca, double theta);
...
extern double (*estimator)(double x, double y);
