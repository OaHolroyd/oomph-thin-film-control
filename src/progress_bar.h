...
public:
   ...
   * @param post_print A function that should be called after the progress bar is printed. It should take a single void*
   *        argument and print any additional information to the end of the line. Must not print a newline.
   * @param period The minimum time in seconds between updates.
   */
  ProgressBar(int total, int width = 50, void (*post_print)(void *) = nullptr, float period = 1.0);
   ...
   * @param data A pointer to any data that should be passed to the post_print function.
